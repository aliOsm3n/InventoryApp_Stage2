...
import com.example.aliothman.inventoryapp_stage2.EditActivity;
import com.example.aliothman.inventoryapp_stage2.R;
import com.example.aliothman.inventoryapp_stage2.data.WardContract;
...
public class DetailsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        decreaseQuantityButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (quantity > 0) {
                    ...
                    values.put(WardContract.ProductEntry.COLUMN_PRODUCT_AVAILABLE_QUANTITY, newQuantity);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        String[] projection = {
                WardContract.ProductEntry._ID,
                WardContract.ProductEntry.COLUMN_PRODUCT_NAME,
                WardContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                WardContract.ProductEntry.COLUMN_PRODUCT_AVAILABLE_QUANTITY,
                WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME,
                WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL,
                WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER};
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (data.moveToFirst()) {
            productName = data.getString(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_NAME));
            pricePerProduct = data.getInt(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_PRICE));
            quantity = data.getInt(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_AVAILABLE_QUANTITY));
            supplierName = data.getString(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME));
            supplierEmail = data.getString(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_EMAIL));
            supplierPhoneNumber = data.getString(data.getColumnIndex(WardContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER));
